...
Note that pressing `Alt-S` to save the layer doesn't save the .psd by default (you can enable this by clicking the toggle next to the save button, but it is slower). 
